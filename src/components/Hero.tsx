...
const Hero = () => {
  ...
  return (
    <section className="relative h-screen flex items-center justify-center" aria-labelledby="hero-heading">
      <div 
      ...
      <div className="relative z-10 text-center text-white space-y-6 px-4 max-w-4xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <Button 
            ...
            aria-label="Znajdź wycieczkę - przewiń do sekcji wyszukiwania"
          >
